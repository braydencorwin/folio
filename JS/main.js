...
const modalGen = (obj) => {
  ...
  modalTextContent1.textContent =
    "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Doloribus, maiores!";
  modalTextContent2.textContent =
...
document.addEventListener("click", (e) => {
  if (
    ...
    e.target ===
      document.querySelector(".modal.is-visible").querySelector(modalClose)
  ) {
